...
)  # (etat_civil/config/settings/base.py - 3 = etat_civil/)
APPS_DIR = ROOT_DIR.path("etat_civil")
...
MIGRATION_MODULES = {"sites": "etat_civil.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "etat_civil.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "etat_civil.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "etat_civil.users.adapters.SocialAccountAdapter"
